          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" method="POST" action="sign-up.php">
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Nome" name="nome2" aria-label="Name" required>
                </div>
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="Email" name="email2" aria-label="Email" required>
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Senha" name="senha2" aria-label="Password" required>
                </div>
