...
$sql = "SELECT * FROM carrinho WHERE id_usuario = $id";
$query = $mysqli->query($sql);
...
if(isset($_GET['id'])){ 
$sql =  "INSERT INTO carrinho (imagem, produto_nome, preco, quantidade, id_usuario) VALUES ('$imagem', '$nome', '$preco', '$quantidade', '$id')";
